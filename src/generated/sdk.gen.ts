...
import {
  ...
  絛2ResponseTransformer,
  鲥12ResponseTransformer,
  鲥5ResponseTransformer,
  鲥7ResponseTransformer,
...
export class LicenseProfiles {
  ...
  public static index<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).get<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/sca/license-profiles', ...options });
  }
  ...
  public static delete<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).delete<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/sca/license-profiles/{license-profile-key}', ...options });
  }
  ...
  public static index1<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/sca/license-profiles/assignable-projects', ...options });
  }
...
export class IssuesReleases {
  ...
  public static deleteComment<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).delete<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/sca/issues-releases/{key}/changelog', ...options });
  }
  ...
  public static getAllAssignees<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/sca/issues-releases/all-assignees', ...options });
  }
}
...
export class MarketplaceAzure {
  ...
  public static billAzureAccount<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).post<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/marketplace/azure/billing', ...options });
  }
}
...
export class Jira {
  ...
  public static 絛<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).delete<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/jira/work-items', ...options });
  }
  ...
  public static 絛1<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).delete<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/jira/project-bindings', ...options });
  }
  ...
  public static 鲥6<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).delete<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/jira/organization-bindings', ...options });
  }
  ...
  public static 鲥10<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<鲥10Responses, unknown, ThrowOnError>(
      { url: '/v2/jira/work-types', ...options },
    );
  }
  ...
  public static 鲥14<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<鲥14Responses, unknown, ThrowOnError>(
      { url: '/v2/jira/user-actions', ...options },
    );
  }
  ...
  public static 鲥16<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<鲥16Responses, unknown, ThrowOnError>(
      { url: '/v2/jira/linked-issues-count/{sonarProjectId}', ...options },
    );
  }
}
...
export class IntegrationConfigurationsController {
  ...
  public static delete1<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).delete<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/integrations/integration-configurations/{id}', ...options });
  }
...
export class FixSuggestions {
  ...
  public static supportedRules<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).get<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/fix-suggestions/supported-rules', ...options });
  }
...
export class Entitlements {
  ...
  public static deactivateLicense<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).post<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/entitlements/offline-deactivation', ...options });
  }
  ...
  public static retrieveRequestFile<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/entitlements/offline-activation', ...options });
  }
  ...
  public static deleteLicense<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).delete<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/entitlements/license', ...options });
  }
  ...
  public static getPurchasableFeatures<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).get<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/entitlements/purchasable-features', ...options });
  }
}
...
export class Atlassian {
  ...
  public static 鲥17<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<鲥17Responses, unknown, ThrowOnError>(
      { url: '/v2/atlassian/auth-url', ...options },
    );
  }
}
...
export class Issues {
  ...
  public static getProjectSandboxSettings<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/issues/sandbox-settings/{projectKey}', ...options });
  }
...
export class SoftwareQualityReportsController {
  ...
  public static 鲥13<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<鲥13Responses, unknown, ThrowOnError>(
      { url: '/v2/software-quality-reports/accessibility-reports', ...options },
    );
  }
}
...
export class SelfTest {
  ...
  >(options: Options<PerformSpringConfigurationSelfTestData, ThrowOnError>) {
    return (options.client ?? client).get<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/sca/self-test/spring-configuration', ...options });
  }
}
...
export class RiskReports {
  ...
  public static getReport<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/sca/risk-reports', ...options });
  }
}
...
export class ScaEnabled {
  ...
  public static getFeatureEnabled1<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).get<
      ...
      unknown,
      ThrowOnError
    >({ url: '/v2/sca/feature-enabled', ...options });
  }
}
...
export class Architecture {
  ...
  public static 鲥19<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<鲥19Responses, unknown, ThrowOnError>(
      { url: '/v2/architecture/graphs/{id}', ...options },
    );
  }
  ...
  public static 鲥20<ThrowOnError extends boolean = false>(
    ...
    return (options.client ?? client).get<鲥20Responses, unknown, ThrowOnError>(
      { url: '/v2/architecture/file-graph', ...options },
    );
  }
}
